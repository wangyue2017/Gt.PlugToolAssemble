...
namespace EventBusExample
{
    ...
    public class CreateQQEventHandler : IRequestResultHandler<CreateQQRequest, Result>
    {
        public Task<Result> Handle(CreateQQRequest request, CancellationToken cancellationToken)
